                                        ...
                                        @foreach($models as $m)
                                            <li>
                                                <a href="#" 
                                                   ...
                                                   class="{{ isset($model) && $m === $model ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-normal">
                            ...
                            <ul role="list" class="-mx-2 space-y-1">
                                @foreach($models as $m)
                                    <li>
                                        <a href="#" 
                                           @click.prevent="loadModel('{{ $modelMap[$m] ?? '' }}')"
                                           :class="currentModel === '{{ $modelMap[$m] ?? '' }}' ? 'bg-gray-50 text-indigo-600 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold' : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-normal'">
                                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.75V12A2.25 2.25 0 014.5 9.75h15A2.25 2.25 0 0121.75 12v.75m-8.69-6.44l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06-.44z" />
                                            </svg>
                                            {{ Str::title(Str::plural(Str::snake(class_basename($m), ' '))) }}
